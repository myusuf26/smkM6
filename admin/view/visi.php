            ...
            <br>
              ...
              <thead>
                ...
                <tbody>
                  <?php
                  $no =1;
                  $query = mysqli_query($koneksi,"SELECT * from tbl_visimisi ");
                  foreach($query as $tampil){          
                  ?>
                  <tr>
                    <td><?php echo $no++?></td>
                    <td><?php echo $tampil['visi'];?></td>
                    <td><?php echo $tampil['misi'];?></td>
                   
                    <td align="center">
                    <button data-user-id="id_visi" class="btn btn-info permissions" data-toggle="modal" data-target="#edit" type="button">Edit</button>
                <a class="btn btn-danger" href="./../backend/hapusvisi.php?id_visi=<?php echo $tampil['id_visi']; ?>">Hapus</a>
              </td>
                  </tr>
                  <?php
                  } 
    ...
    <div id="myModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <label><h3>Lengkapi Informasi Visi dan Misi</h3></label>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
           
          </div>
          <!-- body modal -->
          <div class="modal-body">
          <form action="./../backend/savevisi.php"  id="myForm" method="POST"  enctype="multipart/form-data">
