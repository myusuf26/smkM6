  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Teknik Audio Dan Video</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">TAV</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <br>
              ...
              <thead>
                ...
                <tbody>
                  <?php
                  $no =1;
                  $query = mysqli_query($koneksi,"SELECT * from tbl_tav ORDER BY id_tav ASC");
                  ...
                  <tr>
                    ...
                    <td align="center">
                    <button data-user-id="id_tav" class="btn btn-info permissions" data-toggle="modal" data-target="#edit" type="button">Edit</button>
                <a class="btn btn-danger" href="./../backend/hapustav.php?id_tav=<?php echo $tampil['id_tav']; ?>">Hapus</a>
              </td>
                  </tr>
                  <?php
                  } 
    ...
    <div id="myModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <label><h2>Lengkapi Informasi TAV </h2></label>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
           
          </div>
          <!-- body modal -->
          <div class="modal-body">
          <form action="./../backend/savetav.php"  id="myForm" method="POST"  enctype="multipart/form-data">
