            ...
            <br>
              ...
              <thead>
                ...
                <tbody>
                  <?php
                  $no =1;
                  $query = mysqli_query($koneksi,"SELECT * from user where user.level='admin' ORDER BY nama ASC");
                  ...
                  <tr>
                    ...
                    <td align="center">
                    <button data-user-id="id_user" class="btn btn-info permissions" data-toggle="modal" data-target="#edit" type="button">Edit</button>
                <a class="btn btn-danger" href="./../backend/hapus.php?id_user=<?php echo $tampil['id_user']; ?>">Hapus</a>
              </td>
                  </tr>
                  <?php
                  } 
    ...
    <div id="edit" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <!-- body modal -->
          <div class="modal-body">
          <form action="./../backend/editakun.php"  id="myForm" method="POST" >

          <div class="form-group">
          <label>Id User</label>
            <input type="text" placeholder="id user" name="id_user" value="<?php echo $tampil['id_user']; ?>" class="form-control" id="id_user" readonly >
          </div>
          <div class="form-group">
            <label>Nama Admin</label>
            <input type="text" placeholder="nama admin" name="nama" value="<?php echo $tampil['nama']; ?>" class="form-control" id="nama" >
          </div>
          <div class="form-group">
            <label>Username</label>
            <input type="text" placeholder="username" name="username" value="<?php echo $tampil['username']; ?>" class="form-control" id="username" >
          </div>
          <div class="form-group">
            <label>Password</label>
            <input type="text" placeholder="password" name="password" value="<?php echo $tampil['password']; ?>" class="form-control" id="password" >
          </div>
          <div class="form-group">
          <label>Anda Sebagai : <?php echo $tampil['level']; ?> </label>
          </div>

          <div class="form-group">
            <label for="level">Hak Akses</label>
            <select name="level" class="form-control" id="level" name="level" required>
              <option value="<?php echo $tampil['level'];?>"><?php echo $tampil['level'];?></option>
              <option value="admin">admin</option>
              <option value="petugas">petugas</option>
            </select>
          </div>
