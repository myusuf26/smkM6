  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Teknk Komputer dan Jaringan</h1>
          </div>
          <div class="col-sm-6">
            ...
            <br>
              ...
              <thead>
                ...
                <tbody>
                  <?php
                  $no =1;
                  $query = mysqli_query($koneksi,"SELECT * from tbl_tkj ORDER BY id_tkj ASC");
                  ...
                  <tr>
                    ...
                    <td align="center">
                    <button data-user-id="id_tkj" class="btn btn-info permissions" data-toggle="modal" data-target="#edit" type="button">Edit</button>
                <a class="btn btn-danger" href="./../backend/hapustkj.php?id_tkj=<?php echo $tampil['id_tkj']; ?>">Hapus</a>
              </td>
                  </tr>
                  <?php
                  } 
    ...
    <div id="myModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <label><h2>Lengkapi Informasi TKJ</h2></label>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
           
          </div>
          <!-- body modal -->
          <div class="modal-body">
          <form action="./../backend/savetkj.php"  id="myForm" method="POST"  enctype="multipart/form-data">
