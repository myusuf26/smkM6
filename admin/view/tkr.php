            ...
            <br>
              ...
              <thead>
                ...
                <tbody>
                  <?php
                  $no =1;
                  $query = mysqli_query($koneksi,"SELECT * from tbl_tkr ORDER BY id_tkr ASC");
                  ...
                  <tr>
                    ...
                    <td align="center">
                    <button data-user-id="id_tkr" class="btn btn-info permissions" data-toggle="modal" data-target="#edit" type="button">Edit</button>
                <a class="btn btn-danger" href="./../backend/hapustkr.php?id_tkr=<?php echo $tampil['id_tkr']; ?>">Hapus</a>
              </td>
                  </tr>
                  <?php
                  } 
    ...
    <div id="myModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <label><h2>Lengkapi Informasi TKR</h2></label>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
           
          </div>
          <!-- body modal -->
          <div class="modal-body">
          <form action="./../backend/savetkr.php"  id="myForm" method="POST"  enctype="multipart/form-data">
          
          <div class="form-group">
            <label for="Deskripsi">Deskripsi TKR</label>
    ...
    <div id="edit" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <!-- heading modal -->
          <div class="modal-header">
          <label><h2>Edit Informasi TKR</h2></label>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
