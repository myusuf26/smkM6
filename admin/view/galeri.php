              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="center">
                <a class="btn btn-danger" href="./../backend/hapusgaleri.php?id_galeri=<?php echo $tampil['id_galeri']; ?>">Hapus</a>
              </td>
                  </tr>
                  <?php
                  } 
    ...
    <div id="myModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <label><h2>Tambah Foto</h2></label>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
           
          </div>
          <!-- body modal -->
          <div class="modal-body">
          <form action="./../backend/savegaleri.php"  id="myForm" method="POST"  enctype="multipart/form-data">
